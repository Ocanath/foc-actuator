...
//TODO: do not make this fixed! this should be owned by the caller (i.e. Motor, etc.) and passed to the callback via context. But, we'll get this talking to the hardware first before potentially breaking things
